      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-[1.15fr_0.85fr] md:items-center md:py-28">
        <div>
          ...
          <h1 className="max-w-3xl text-4xl font-semibold leading-tight tracking-tight text-slate-950 md:text-6xl">
            O MAEZTRO Gestão organiza sua agenda, seus alunos e suas finanças em um só lugar.
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
            Uma plataforma de gestão para profissionais que precisam planejar aulas e compromissos, acompanhar alunos e controlar as finanças do dia a dia.
          </p>
